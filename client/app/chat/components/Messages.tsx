            ...
            {conversation == null ? (
                <div className="w-full flex flex-col items-center justify-center gap-5 text-center px-4">
                    <h1 className="text-5xl font-bold text-white">
                        Hello {user?.displayName ? user.displayName : 'Jack'} To <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-500/80 to-white">
                            PsAi
                        </span>
                    ...
                    <div className="grid lg:grid-cols-4 grid-cols-2 gap-10">
                        {avatars.map((avatar, index) => (
                            <Image key={index} src={avatar} alt="avatar" width={250} height={250}

                                className="rounded-xl border-[0.5px] border-white
